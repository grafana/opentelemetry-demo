...
const { ENV_PLATFORM, WEB_APP_SERVICE_NAME, PUBLIC_OTEL_EXPORTER_OTLP_TRACES_ENDPOINT, GRAFANA_FARO_ENDPOINT } = process.env;

const envString = `
window.ENV = {
  NEXT_PUBLIC_PLATFORM: '${ENV_PLATFORM}',
  NEXT_PUBLIC_OTEL_SERVICE_NAME: '${WEB_APP_SERVICE_NAME}',
